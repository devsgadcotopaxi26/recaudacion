    ...
    <div class="flex">
      ...
      <aside class="w-64 bg-white shadow-lg min-h-screen">
        <nav class="mt-6 px-4">
          ...
          <!-- Consultar Valores - Admin y verificacionpagos -->
          <Link
            v-if="
              $page.props.auth.user.roles.some(
                (r) => r.name === 'admin' || r.name === 'verificacionpagos',
              )
            "
          ...
          <!-- Verificar Pago (comprobante/QR) - Admin y verificacionpagos -->
          <Link
            v-if="
              $page.props.auth.user.roles.some(
                (r) => r.name === 'admin' || r.name === 'verificacionpagos',
            ...
            class="flex items-center px-4 py-3 mb-2 text-gray-700 rounded-lg transition duration-200"
            :class="
              $page.url.startsWith('/admin/verificar-pago')
                ? 'text-white font-semibold'
                : 'hover:bg-gray-100'
            "
            :style="
          ...
          <!-- Reporte de Conciliación - Solo Admin -->
          <Link
            v-if="$page.props.auth.user.roles.some((r) => r.name === 'admin')"
